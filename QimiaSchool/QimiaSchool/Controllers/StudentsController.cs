...
namespace QimiaSchool.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> CreateStudent([FromBody] CreateStudentDto student, CancellationToken cancellationToken)
        {
            var response = await _mediator.Send(new CreateStudentCommand(student), cancellationToken);
            return CreatedAtAction(nameof(GetStudent),new { Id = response },student);
        ...
        { 
            return  _mediator.Send(new GetStudentsQuery(), cancellationToken);
        ...
        {
            await _mediator.Send(
                new DeleteStudentCommand(id), cancellationToken);
            return NoContent();
        }
    }
